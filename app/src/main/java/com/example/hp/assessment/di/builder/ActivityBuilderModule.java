...
package com.example.hp.assessment.di.builder;


import com.example.hp.assessment.activities.MovieListActivity;
...
public abstract class ActivityBuilderModule {
    ...
    abstract MovieListActivity bindMovieActivity();

    /*@ContributesAndroidInjector(modules = {MainActivityModule.class,
            AboutFragmentProvider.class, RateUsDialogProvider.class})
    abstract MovieListActivity bindMainActivity();
